...
public class Level1 {
    ...
    public static void main(String[] args) {
         ...
         */
        teachers.stream().forEach(teacher -> System.out.println("la liste des enseignants" + teacher));
         ...
         */
        teachers.stream().filter(teacher -> teacher.getSubject().equals(Subject.JAVA)).distinct().sorted(((o1, o2) -> o1.getSalary() - o2.getSalary())).forEach(System.out::println);
        ...
        /* First Way */
        teachers.stream().filter(teacher -> teacher.getSalary() > 60000 ).forEach(teacher -> System.out.println("la liste des enseignants" + teacher.getName()));
        /* Second Way */
